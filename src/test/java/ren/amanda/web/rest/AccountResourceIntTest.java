package ren.amanda.web.rest;

import ren.amanda.AmandaApp;
import ren.amanda.domain.Authority;
import ren.amanda.domain.User;
import ren.amanda.repository.AuthorityRepository;
import ren.amanda.repository.UserRepository;
import ren.amanda.security.AuthoritiesConstants;
import ren.amanda.service.MailService;
import ren.amanda.service.UserService;
import ren.amanda.service.dto.UserDTO;
import ren.amanda.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = AmandaApp.class)
public class AccountResourceIntTest {
    ...
    public void testGetExistingAccount() throws Exception {
        ...
        restUserMockMvc.perform(get("/api/account")
                ...
                .andExpect(jsonPath("$.mobile").value("13812345678"))
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        ManagedUserVM duplicatedUser = new ManagedUserVM(validUser.getId(), validUser.getLogin(), validUser.getPassword(), validUser.getLogin(), validUser.getLastName(), validUser.getMobile(),
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        ...
        ManagedUserVM duplicatedUser = new ManagedUserVM(validUser.getId(), "johnjr", validUser.getPassword(), validUser.getLogin(), validUser.getLastName(), validUser.getMobile(),
