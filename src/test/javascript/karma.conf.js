...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'src/main/webapp/bower_components/screenfull/dist/screenfull.js',
            ...
            'src/main/webapp/bower_components/angular-screenfull/dist/angular-screenfull.js',
            'src/main/webapp/bower_components/angular-ui-tinymce/src/tinymce.js',
            'src/main/webapp/bower_components/echarts/dist/echarts.js',
            'src/main/webapp/bower_components/echarts/map/js/world.js',
            'src/main/webapp/bower_components/echarts/theme/roma.js',
            // endbower
