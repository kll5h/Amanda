...
gulp.task('themes', [], function () {
    return gulp.src(config.app + 'content/themes/**')
        .pipe(plumber({errorHandler: handleErrors}))
        .pipe(changed(config.dist + 'content/themes/'))
        .pipe(gulp.dest(config.dist + 'content/themes/'));
});
...
gulp.task('assets:prod', ['images', 'styles', 'html', 'copy:swagger', 'themes', 'copy:images'], build);
...
gulp.task('watch', function () {
    ...
    gulp.watch(config.app + 'content/themes/**', ['themes']);
