...
To optimize the amanda application for production, run:
...
mvn install:install-file -Dfile=lib/taobao-sdk-java-auto_1455552377940-20160607.jar -DgroupId=taobao -DartifactId=taobao-sdk-java-auto -Dversion=1455552377940-20160607 -Dpackaging=jar
